...
$('#target').keypress(function(e){
  ...
  function getNewWord()//called by wordcomplete function to get a new word and increment the wordstyped(number) by one
  {
	...
	var str1, str;
	for(var i=0, str1="";i<wordstyped;i++)
	    str1 += fileWordsArray[i]+" ";
    $("#wordstyped").html(str1+ " ");
	
	str=fileWordsArray[wordstyped++];//for next word to type
	$("#wordtotype").html(str+" ");
	...
	var str3;
    for(var i=wordstyped, str=""; i<fileWordsArray.length; i++)
	    str3 += fileWordsArray[i];
	$("#wordtotype").html(str3 + " "); 	
